...
bot_username = os.environ.get("BOT_USERNAME","Rename_VS_Bot")
log_channel = int(os.environ.get("LOG_CHANNEL", "-1002752116975"))
token = os.environ.get('TOKEN', '7672085347:AAEiOie3st0Wd-1I6n_ulTZu0wIIvmjAbmo')
botid = token.split(':')[0]
FLOOD = 500
...
async def start(client, message):
	...
	**Document Or Video** and enter new filename to rename it__
	""", reply_to_message_id=message.id,
                                     reply_markup=InlineKeyboardMarkup(
                                         [[InlineKeyboardButton("🔺 Update Channel 🔺", url="https://t.me/Cartoonworldtelugu")],
                                          [InlineKeyboardButton("🦋 Subscribe us 🦋", url="https://youtube.com/@pokemonintelugu")],
                                          [InlineKeyboardButton("Support Group", url='https://t.me/Pokemonallseasonsintelugu'),
                                          InlineKeyboardButton("Movie Channel", url='https://t.me/Cartoonworldtelugu_india')],
...
async def send_doc(client, message):
    ...
    try:
        ...
        await message.reply_text(text=f"Hello dear {message.from_user.first_name}  **we are currently working on this issue**\n\nPlease try to rename files from your another account.\nBecause this BOT can't rename file sent by some ids.\n\nIf you are an **ADMIN** Don't worry ! here we have a solution for you dear {message.from_user.first_name }.\n\nPlease use \n👉 `/addpremium your_other_userid` 👈 to use premium feautres\n\n",
                                  reply_markup=InlineKeyboardMarkup([
                                                                     [InlineKeyboardButton("🦋 Contact LazyDeveloper 🦋", url='https://telegram.me/Cartooworldtelugu_india')],
                                                                     [InlineKeyboardButton("🔺 Watch Tutorial 🔺", url='https://youtube.com/@pokemonintelugu')],
                                                                     [InlineKeyboardButton("🦋 Visit Channel  ", url='https://t.me/Cartoonworldtelugu_india'),
                                                                     InlineKeyboardButton("  Support Group 🦋", url='https://t.me/Pokemonallseasonsintelugu')],
                                                                     [InlineKeyboardButton("☕ Buy Me A Coffee ☕", url='')]
                                                                    ]))
        await message.reply_text(text=f"🦋")
